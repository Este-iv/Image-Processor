...
public class GraphTest {
	...
	void testV2V1() throws IOException {
		...
		solution.add(5);
		solution.add(6);
		System.out.println("my answer " + wg.V2V(1, 2, 5, 6));
	...
	void testV2V2() throws IOException {
		...
		solution.add(3);
		solution.add(4);
		System.out.println("my answer " + wg.V2V(1, 2, 3, 4));
	...
	void testV2V3() throws IOException {
		...
		solution.add(4);
		solution.add(4);
		System.out.println("my answer " + wg.V2V(1, 2, 4, 4));
	...
	void testV2V4() throws IOException {	
		...
		WGraph wg = new WGraph("example.txt");
		ArrayList<Integer> solution = new ArrayList<Integer>();
		System.out.println("my answer " + wg.V2V(9, 2, 3, 4));
	...
	void testV2V5() throws IOException {
		...
		solution.add(3);
		solution.add(4);
		System.out.println("my answer " + wg.V2V(2, 2, 3, 4));
	...
	void testV2V6() throws IOException {
		...
		solution.add(1);
		solution.add(2);
		System.out.println("my answer " + wg.V2V(1, 2, 1, 2));
	...
	void testS2V1() throws IOException {
		...
		solution.add(3);
		solution.add(4);
		System.out.println("my answer " + wg.V2S(1, 2, s));
	...
	void testS2V2() throws IOException {
		...
		s.add(3);
		s.add(4);
		System.out.println("my answer " + wg.V2S(1, 5, s));
	...
	void testS2V5() throws IOException {
		...
		solution.add(5);
		solution.add(6);
		System.out.println("my answer " + wg.V2S(7, 8, s));
	...
	void testS2S1() throws IOException {
		...
		solution.add(5);
		solution.add(6);
		System.out.println("my answer " + wg.S2S(s1, s2));
